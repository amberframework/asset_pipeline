...
role: "article"
abstract: "A picker displays one or more scrollable lists of distinct values that people can choose from."
...
![A stylized representation of a selected item in a scrollable list. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](../images/components-pickers-intro.png)
