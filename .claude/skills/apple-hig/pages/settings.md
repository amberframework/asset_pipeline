...
role: "article"
abstract: "People expect apps and games to just work, but they also appreciate having ways to customize the experience to fit their needs."
...
![A sketch of a gear, suggesting configuration. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.](../images/patterns-settings-intro.png)
...
**Include a settings item in the [App menu](./the-menu-bar.md).** Avoid adding settings buttons to a window’s toolbar, because doing so decreases the space available for essential commands that people use frequently. If you provide document-level options, add this item to your app’s [File menu](./the-menu-bar.md).
