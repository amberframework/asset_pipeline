...
role: "article"
abstract: "Great collaboration and sharing experiences are simple and responsive, letting people engage with the content while communicating effectively with others."
...
![A sketch of a person with an overlapping checkmark, suggesting effective collaboration. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.](../images/patterns-collaboration-and-sharing-intro.png)
...
![An illustration of a Notes document on iPhone. The document toolbar prominently features the Share button next to the More button.](../images/collaboration-share-button.png)
...
![An illustration of a Notes document with the share sheet open on iPhone, with collaboration options set to indicate that only invited people can edit the selected document.](../images/collaboration-sharing-permission-invited.png)

![An illustration of a Notes document with the share sheet open on iPhone, with collaboration options set to indicate that everyone can make changes to the selected document.](../images/collaboration-sharing-permission-everyone.png)
...
![An illustration of a Notes document open on iPhone. The document toolbar prominently features the Collaboration button next to the Share button.](../images/collaboration-status-active-collaboration-button.png)
...
![An illustration of a Notes document on iPhone. A menu is open from the Collaboration button in the document toolbar, with buttons to display the most recent updates and activities.](../images/collaboration-custom-popover-notes.png)
