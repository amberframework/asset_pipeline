...
role: "article"
abstract: "Privacy is paramount: it’s critical to be transparent about the privacy-related data and resources you require and essential to protect the data people allow you to access."
...
![A sketch of an upright hand, suggesting protection. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.](../images/foundations-privacy-intro.png)
...
| --- | --- | --- |
| ![A checkmark in a circle to indicate a correct example.](../images/checkmark.png) | The app records during the night to detect snoring sounds. | An active sentence that clearly describes how and why the app collects the data. |
| ![An X in a circle to indicate an incorrect example.](../images/crossout.png) | Microphone access is needed for a better experience. | A passive sentence that provides a vague, undefined justification. |
| ![An X in a circle to indicate an incorrect example.](../images/crossout.png) | Turn on microphone access. | An imperative sentence that doesn’t provide any justification. |
...
![A screenshot of an app’s pre-alert screen that includes a button titled Cancel that appears below the Next button.](../images/privacy-custom-messaging-incorrect-cancel-button.png)

![An X in a circle to indicate an incorrect example.](../images/crossout.png)

![A screenshot of an app’s pre-alert screen that includes a Close button in the top-left corner. The Next button appears near the bottom of the screen.](../images/privacy-custom-messaging-incorrect-close-button.png)
...
![An image of a lozenge-shaped blue button that displays a white location indicator — that is, a narrow arrow head shape that points to the top right — followed by the text Current Location.](../images/location-button.png)
