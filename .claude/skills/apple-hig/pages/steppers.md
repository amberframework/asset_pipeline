...
role: "article"
abstract: "A stepper is a two-segment control that people use to increase or decrease an incremental value."
...
![A stylized representation of a stepper control. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](../images/components-stepper-intro.png)
