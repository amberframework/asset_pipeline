...
role: "article"
abstract: "When it doesn’t create an unnecessary barrier to your experience, an account can be a convenient way for people to access their content and track personal details."
...
![A sketch of a person, suggesting personal information. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.](../images/patterns-managing-accounts-intro.png)
...
> **Note:**
> If people used [Sign in with Apple](./sign-in-with-apple.md) to create an account within your app, you revoke the associated tokens when they delete their account. See [Token revocation](https://developer.apple.com/documentation/SigninwithAppleRESTAPI/Revoke-tokens).
...
In addition to helping people understand these scenarios, provide information that describes how to cancel subscriptions and manage purchases. For guidance, see [Helping people manage their subscriptions](./in-app-purchase.md) and [Providing help with in-app purchases](./in-app-purchase.md).
