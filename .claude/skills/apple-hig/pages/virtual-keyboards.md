...
role: "article"
abstract: "On devices without physical keyboards, the system offers various types of virtual keyboards people can use to enter data."
...
![A stylized representation of a numeric keypad shown on top of a grid that suggests the canvas of a design tool. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](../images/components-virtual-keyboard-intro.png)
...
![An illustration of an app layout on iPhone, showing two stacked text fields and a button above the keyboard.](../images/ui-fully-visible.png)

![A checkmark in a circle to indicate a correct example.](../images/checkmark.png)

![An illustration of an app layout on iPhone, showing two stacked text fields. The keyboard covers part of the bottom text field.](../images/text-field-hidden.png)

![An X in a circle to indicate an incorrect example.](../images/crossout.png)

![An illustration of an app layout on iPhone, showing two stacked text fields and a button above the keyboard. The keyboard covers part of the button.](../images/button-hidden.png)
