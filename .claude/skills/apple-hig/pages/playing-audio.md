...
role: "article"
abstract: "People expect rich audio experiences that automatically adjust when the context changes on the device."
...
![A sketch of a speaker emitting sound waves, suggesting the playback of audio. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.](../images/patterns-playing-audio-intro.png)
