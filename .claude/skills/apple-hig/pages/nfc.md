...
role: "article"
abstract: "Near-field communication (NFC) allows devices within a few centimeters of each other to exchange information wirelessly."
...
![A sketch of progressively larger curved lines extending toward the right, suggesting near-field communication. The image is overlaid with rectangular and circular grid lines and is tinted blue to subtly reflect the blue in the original six-color Apple logo.](../images/technologies-nfc-intro.png)
...
![An illustration of a scanning sheet on iPhone, which includes the text Ready to Scan and Hold your device near the NFC tag, and a Cancel button.](../images/nfc-ready-to-scan.png)
...
![An illustration of a notification banner above the Home screen on iPhone, which offers an opportunity to open a specific app to process NFC tag data detected nearby.](../images/nfc-background.png)
