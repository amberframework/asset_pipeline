...
slug: "imessage-apps-and-stickers"
source_url: "https://developer.apple.com/design/human-interface-guidelines/imessage-apps-and-stickers"
role: "article"
abstract: "An iMessage app can help people share content, collaborate, and even play games with others in a conversation; stickers are images that people can use to decorate a conversation."
...
![A sketch of the iMessage App Store icon. The image is overlaid with rectangular and circular grid lines and is tinted blue to subtly reflect the blue in the original six-color Apple logo.](../images/technologies-iMessage-Apps-intro.png)
...
![An illustration showing a grid of small stickers in the bottom half of an iPhone screen. Eight stickers are visible in the area, followed by a partial row of four, arranged in three rows.](../images/sticker-sizes-small.png)

![An illustration showing a grid of regular stickers in the bottom half of an iPhone screen. Six stickers are visible in the area, in two rows of three.](../images/sticker-sizes-regular.png)

![An illustration showing a grid of large stickers in the bottom half of an iPhone screen. Two stickers are fully visible in the area, followed by a partial row of two additional stickers.](../images/sticker-sizes-large.png)
