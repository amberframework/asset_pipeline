...
role: "article"
abstract: "A combo box combines a text field with a pull-down button in a single control."
...
![A stylized representation of a combo box control displaying a list of cities. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](../images/components-combobox-intro.png)
