...
role: "article"
abstract: "On a Mac or an iPad, the menu bar at the top of the screen displays the top-level menus in your app or game."
...
![A stylized representation of the macOS menu bar displaying a selected menu. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](../images/components-the-menu-bar-intro.png)
...
Keyboard shortcuts in iPadOS use the same patterns as in macOS. For guidance, see [Standard keyboard shortcuts](./keyboards.md).

![An illustration of an app window on iPad, with its menu bar appearing at the top of the screen and the Edit menu open.](../images/menu-bar-ipad-overview.png)
...
In addition, the macOS menu bar includes the Apple menu on the leading side and menu bar extras on the trailing side. See [macOS](./the-menu-bar.md) for guidance.
...
> **Important:**
> The View menu doesn’t include items for navigating between or managing specific windows; the [Window menu](./the-menu-bar.md) provides these commands.
...
> **Important:**
> The Window menu doesn’t help people customize the appearance of windows or close them. To customize a window, people use commands in the [View menu](./the-menu-bar.md); to close a window, people choose Close in the [File menu](./the-menu-bar.md).
...
| Zoom | Toggles between a predefined size appropriate to the window’s content and the window size people set. Pressing the Option key changes this item to Zoom All. | Avoid using Zoom to enter or exit full-screen mode. The [View menu](./the-menu-bar.md) supports these functions. |
...
The menu bar in macOS includes the Apple menu, which is always the first item on the leading side of the menu bar. The Apple menu includes system-defined menu items that are always available, and you can’t modify or remove it. Space permitting, the system can also display menu bar extras in the trailing end of the menu bar. For guidance, see [Menu bar extras](./the-menu-bar.md).
...
![A screenshot of the Input menu bar extra and its menu.](../images/menu-bar-extras.png)
...
[Standard keyboard shortcuts](./keyboards.md)
