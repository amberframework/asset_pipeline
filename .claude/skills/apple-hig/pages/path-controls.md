...
role: "article"
abstract: "A path control shows the file system path of a selected file or folder."
...
![A stylized representation of a path control for a HIG Design document showing its root disk, parent folder, and selected item. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](../images/components-path-control-intro.png)
...
![A screenshot of a Finder path bar that displays a hierarchy of four locations.](../images/path-controls-standard.png)
...
![A screenshot of a path control showing a folder icon and a pop-up control.](../images/path-controls-popup.png)
