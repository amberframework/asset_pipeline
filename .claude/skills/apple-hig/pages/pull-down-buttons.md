...
role: "article"
abstract: "A pull-down button displays a menu of items or actions that directly relate to the button’s purpose."
...
![A stylized representation of a pull-down menu displaying a set of items. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](../images/components-pull-down-button-intro.png)
...
![A screenshot of the Notes app on iPhone, open to a Notes document titled Nature Walks. The top toolbar includes a More button on the trailing edge.](../images/menu-secondary-actions-collapsed.png)

![A screenshot of the Notes app on iPhone, open to a Notes document titled Nature Walks. The More button in the top toolbar is expanded, revealing the More menu with additional funtionality.](../images/menu-secondary-actions-expanded.png)
