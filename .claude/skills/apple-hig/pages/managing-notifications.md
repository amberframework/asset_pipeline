...
role: "article"
abstract: "Notifications can give people timely and important information, whether the device is locked or in use."
...
![A sketch of bell with a small overlapping circle, suggesting a notification sound. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.](../images/patterns-managing-notifications-intro.png)
