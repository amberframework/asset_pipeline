...
role: "article"
abstract: "Lists and tables present data in one or more columns of rows."
...
![A stylized representation of a three-row table with header and footer text. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](../images/components-lists-and-tables-intro.png)
...
![An illustration of a grouped list of rows. Each list item includes an info button at the trailing end of the row.](../images/info-button-in-list.png)

![An illustration of a grouped list of rows. Each list item includes a right-pointing chevron at the trailing end of the row.](../images/disclosure-indicator-in-list.png)
