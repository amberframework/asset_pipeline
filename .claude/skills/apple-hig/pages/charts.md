...
role: "article"
abstract: "Organize data in a chart to communicate information with clarity and visual appeal."
...
![A stylized representation of a bar chart. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](../images/components-charts-intro.png)
...
![A bar chart with callouts that identify chart components, such as axes, grid lines, marks, ticks, axis value labels, and the overall plot area.](../images/charts-anatomy.png)

A *mark* is a visual representation of a data value. You create a chart by supplying one or more series of data values, assigning each value to a mark. To specify the style of chart you want to display — such as bar chart, line chart, or scatter plot — you choose a mark type, such as bar, line, or point (for guidance, see [Marks](./charts.md)). The general task of depicting individual data values in a chart is called *plotting*, and the area that contains the marks is called the *plot area*.
...
Clear, accurate descriptions can help make a chart more approachable and accessible; to learn about additional ways to improve the accessibility of your chart, see [Enhancing the accessibility of a chart](./charts.md).
...
![A bar chart that depicts the number of steps for each day in a month.](../images/charts-bar-marks.png)
...
![A line chart that depicts the performance of a stock over a five-year period.](../images/charts-line-marks.png)
...
![A point-mark chart that depicts per-day readings of heartbeats per minute over a 5 1/2-month period.](../images/charts-point-marks.png)
...
![An illustration of Battery Settings, which uses a chart to depict battery charge over time, where the charge can vary within a fixed range from 0% to 100%.](../images/charts-fixed-range-axis.png)
...
![An illustration of the Steps chart in the Health app, which shows the average number of steps per day for a single week.](../images/charts-dynamic-range-axis-small.png)

![An illustration of the Steps chart in the Health app, which shows the average number of steps per day in a one-month period.](../images/charts-dynamic-range-axis-large.png)
...
![An illustration of the rain forecast for the next hour in the Weather app, which uses succinct, plain language to describe the expected precipitation.](../images/charts-descriptive-content.png)
...
As in all other parts of your interface, using color in a chart can help you clarify information, evoke your brand, and provide visual continuity. For general guidance on using color in ways that everyone can appreciate, see [Inclusive color](./color.md).
...
![An illustration of a blood pressure chart in the Health app that uses a red circle to represent systolic values and a black or white diamond to represent diastolic values.](../images/charts-colors.png)
...
![An illustration of a chart in Maps that shows the range of elevations over the total distance of the trip. A VoiceOver focus indicator is visible on top of the chart, containing approximately one-fifth of the total distance and elevation.](../images/charts-bar-chart-with-voiceover-focus.png)
